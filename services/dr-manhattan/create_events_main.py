...
def create_events(ts_start, ts_end):
    ...
    com = Louvaine('http://watchman:3003/api/',
               'http://watchman:3003/api/extract/entities',
               'http://watchman:3003/api/geocoder/forward-geo')
    lp_n = Loopy('http://watchman:3003/api/aggregateClusters', query_params)
    while True:
    ...
    lp_e = Loopy('watchman:3003/api/clusterLinks', query_params)
    while True:
